 ...
 *
 * Outputs: 
 * int maxCount - the maximum number of iterations required by any pixel 
 *                in the process
 * --------------------------------------------------------------------
 * This function evenly divides the image to calculate into blocks and 
 * sends them to each process using Scatterv. The image blocks are 
 * recombined on process 0 using Gatherv.
*/
